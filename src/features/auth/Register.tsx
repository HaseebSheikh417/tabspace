      ...
      <div className="card text-bg-dark border-secondary p-4 shadow" style={{ width: '100%', maxWidth: '400px' }}>
        <div className="card-body">
          <div className="text-center mb-4">
            ...
            <p className="text-secondary small">Join Tabspace today</p>
          </div>
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn btn-primary w-100 mb-3 fw-bold">Register</button>
            <div className="text-center text-secondary small">
              Already have an account? <Link to="/login" className="text-decoration-none">Sign in</Link> or <Link to="/" className="text-decoration-none">Use as guest</Link>
            </div>
          </form>
        </div>
      </div>
